...
func (_m *MarketMapOverride) OverrideGeneratedMarkets(ctx context.Context, logger *zap.Logger, actual types.MarketMap, generated types.MarketMap, options update.Options) (types.MarketMap, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *zap.Logger, types.MarketMap, types.MarketMap, update.Options) (types.MarketMap, error)); ok {
	...
	if rf, ok := ret.Get(1).(func(context.Context, *zap.Logger, types.MarketMap, types.MarketMap, update.Options) error); ok {
...
func (_c *MarketMapOverride_OverrideGeneratedMarkets_Call) Return(_a0 types.MarketMap, _a1 error) *MarketMapOverride_OverrideGeneratedMarkets_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MarketMapOverride_OverrideGeneratedMarkets_Call) RunAndReturn(run func(context.Context, *zap.Logger, types.MarketMap, types.MarketMap, update.Options) (types.MarketMap, error)) *MarketMapOverride_OverrideGeneratedMarkets_Call {
	_c.Call.Return(run)
	return _c
}
