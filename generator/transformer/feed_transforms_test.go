...
func TestResolveConflicts(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			cfg:  config.GenerateConfig{},
			feeds: []types.Feed{
				types.NewFeed(marketBtcUsdNormalized.Ticker, marketBtcUsdNormalized.ProviderConfigs[0], 10000.0,
					10000.0, liquidityInfo1000, cmcInfoA),
				types.NewFeed(marketBtcUsd.Ticker, marketBtcUsdt.ProviderConfigs[0], 20000.0, 20000.0,
					liquidityInfo2000, cmcInfoA),
			},
			transformed: []types.Feed{
				types.NewFeed(marketBtcUsd.Ticker, marketBtcUsdt.ProviderConfigs[0], 20000.0, 20000.0, liquidityInfo2000, cmcInfoA),
			},
			expectErr: false,
		},
		{
		...
		},
		{
			...
			feeds: []types.Feed{
				...
				types.NewFeed(marketBtcUsdt.Ticker, marketBtcUsdt.ProviderConfigs[0], 25000.0, 20000.0, liquidityInfo4000, cmcInfoA),
			},
			transformed: []types.Feed{
				types.NewFeed(marketBtcUsdt.Ticker, marketBtcUsdt.ProviderConfigs[0], 25000.0, 20000.0, liquidityInfo4000, cmcInfoA),
				types.NewFeed(marketBtcUsdNormalized.Ticker, marketBtcUsdNormalized.ProviderConfigs[0], 10000.0,
	...
	tests := []struct {
		...
		},
		{
			...
			feeds: []types.Feed{
				types.NewFeed(marketBtcUsdNormalized.Ticker, marketBtcUsdNormalized.ProviderConfigs[0], 10000.0,
					20000.0, liquidityInfo2000, cmcInfoA),
				types.NewFeed(marketBtcUsdt.Ticker, marketBtcUsdt.ProviderConfigs[0], 20000.0, 20000.0, liquidityInfo2000, cmcInfoA),
			},
			transformed: []types.Feed{
				types.NewFeed(marketBtcUsdNormalized.Ticker, marketBtcUsdNormalized.ProviderConfigs[0], 10000.0,
					20000.0, liquidityInfo2000, cmcInfoA),
...
func TestPruneByQuoteVolume(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			feeds: []types.Feed{
				types.NewFeed(marketBtcUsdNormalized.Ticker, marketBtcUsdNormalized.ProviderConfigs[0], 100000.0,
					20000.0, liquidityInfo2000, cmcInfoA),
				types.NewFeed(marketBtcUsdt.Ticker, marketBtcUsdt.ProviderConfigs[0], 200000.0, 20000.0, liquidityInfo2000, cmcInfoA),
			},
			transformed: []types.Feed{
				types.NewFeed(marketBtcUsdNormalized.Ticker, marketBtcUsdNormalized.ProviderConfigs[0], 100000.0,
					20000.0, liquidityInfo2000, cmcInfoA),
		...
		},
		{
			...
			feeds: []types.Feed{
				types.NewFeed(marketBtcUsd.Ticker, marketBtcUsd.ProviderConfigs[0], 100000, 20000.0, liquidityInfo2000, cmcInfoA),
			},
			transformed: []types.Feed{
				types.NewFeed(marketBtcUsd.Ticker, marketBtcUsd.ProviderConfigs[0], 100000, 20000.0, liquidityInfo2000, cmcInfoA),
			},
		...
		},
		{
			...
			feeds: []types.Feed{
				types.NewFeed(marketBtcUsd.Ticker, marketBtcUsd.ProviderConfigs[0], 0, 20000.0, liquidityInfo2000, cmcInfoA),
			},
			transformed: []types.Feed{},
			dropped:     []string{marketBtcUsd.Ticker.String()},
			expectErr:   false,
	...
	tests := []struct {
		...
		},
		{
			...
			feeds: []types.Feed{
				...
				types.NewFeed(marketBtcUsdt.Ticker, marketBtcUsdt.ProviderConfigs[0], 200000.0, 200000.0, liquidityInfo2000, cmcInfoNull),
			},
			transformed: []types.Feed{
				types.NewFeed(marketBtcUsdNormalized.Ticker, marketBtcUsdNormalized.ProviderConfigs[0], 100000.0,
					200000.0, liquidityInfo2000, cmcInfoNull),
		...
		},
		{
			...
			feeds: []types.Feed{
				types.NewFeed(marketBtcUsd.Ticker, marketBtcUsd.ProviderConfigs[0], 100000, 200000.0, liquidityInfo2000, cmcInfoNull),
			},
			transformed: []types.Feed{
				types.NewFeed(marketBtcUsd.Ticker, marketBtcUsd.ProviderConfigs[0], 100000, 200000.0, liquidityInfo2000, cmcInfoNull),
			},
		...
		},
		{
			...
			feeds: []types.Feed{
				types.NewFeed(marketBtcUsd.Ticker, marketBtcUsd.ProviderConfigs[0], 0, 20000.0, liquidityInfo2000, cmcInfoNull),
			},
			transformed: []types.Feed{},
			dropped:     []string{marketBtcUsd.Ticker.String()},
			expectErr:   false,
